...
class MainSelectorComponent(ModeSelectorComponent):
	...
	def __init__(self, matrix, top_buttons, side_buttons, config_button, parent):
		self._parent = parent
		self.log("MainSelectorComponent::__init__")
...
#		self._zooming.set_empty_value(LED_OFF)
	...
	def disconnect(self):
		self.log("MainSelectorComponent::disconnect")
...
#		self._zooming = None
	...
	def set_modes_buttons(self, buttons):
		self.log("MainSelectorComponent::set_modes (" + str(buttons) + ")")
	...
	def set_mode(self, mode):
		self.log("MainSelectorComponent::set_mode (" + str(mode) + ")")
	...
	def _update_mode_buttons(self):
		self.log("MainSelectorComponent::_update_mode_buttons")
	...
	def update(self):
		...
		if self.is_enabled():
			self.log("MainSelectorComponent::update")
...
#			self._zooming.set_allow_update(True)
	...
	def _update_control_channels(self):
		self.log("MainSelectorComponent::_update_control_channels")
	...
	def _setup_session(self, as_active, as_enabled):
		self.log("MainSelectorComponent::_setup_session")
...
#			self._session.set_track_bank_buttons(None, None)
	...
	def _setup_quick_mix(self, as_active):
		if self._quick_mix!=None:
			self.log("MainSelectorComponent::_setup_quick_mix")
			if as_active:
	...
	def _setup_step_sequencer(self, as_active, mode):
		if(self._stepseq!=None):
			self.log("MainSelectorComponent::_setup_step_sequencer")
...
#			self.log("MainSelectorComponent::_setup_device_controller")
#			if as_active:
#				#for button in range(8):
#				#	self._side_buttons[button].set_enabled(True)
...
#				self._device_controller.set_enabled(False)
	...
	def _setup_mixer(self, as_active):
		self.log("MainSelectorComponent::_setup_mixer")
		assert isinstance(as_active, type(False))
	...
	def _setup_user1(self, release_matrix=True,release_side_buttons =True,release_nav_buttons = True):
		self.log("MainSelectorComponent::_setup_user1")
		for scene_index in range(8):
	...
	def _setup_user2(self, release_buttons):
		self.log("MainSelectorComponent::_setup_user2")
		for scene_index in range(8):
			scene_button = self._side_buttons[scene_index]
			scene_button.set_on_off_values(127, LED_OFF)
			scene_button.turn_off()
	...
	def _init_session(self):
		self.log("MainSelectorComponent::_init_session")		
